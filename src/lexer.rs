...
/**
'Lexer' is implemented for any entity which implements the 'lexer::CommonClassifier' trait

'lexer::CommonClassifier': a tokenization strategy where N chars can be mapped to one of the categories/variants stored in enum 'CommonClass'. The implementor is responsible for the mapping
*/
    ...
    fn handle_token(&mut self, it: &mut CharStreamReader) -> Result<Option<String>> {
        ...
        match class {
            ...
            None => {
                ...
                Err(LexerError::AutomataException(pos))
            }
        }
    }
}
